...
// source is the Marble Grand Prix "M" sticker mark (app/icon.svg),
// rasterized to PNG (public/icons/*) since manifest icons need broad
// OS/launcher support that raw SVG doesn't reliably get on Android.
