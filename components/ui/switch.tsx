  ...
  return (
    <SwitchPrimitive.Root
      ...
      className={cn(
        ...
        "peer inline-flex h-5 w-9 shrink-0 items-center rounded-full border border-border-subtle bg-surface-secondary transition-colors outline-none focus-visible:ring-3 focus-visible:ring-ring/50 disabled:cursor-not-allowed disabled:opacity-50 data-checked:border-transparent data-checked:bg-accent-primary dark:border-transparent",
        className
      )}
      {...props}
    >
